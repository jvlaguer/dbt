...
table_active_mom_cnt_distinct_host  as (
    ...
    GROUP BY listing_neighbourhood, TO_CHAR(scraped_date, 'MM/YYYY')
...
table_active_pcnt_change_cnt_distinct_host  as (
    ...
    SELECT *,
    LAG(cnt_distinct_host, 1) OVER (PARTITION BY listing_neighbourhood ORDER BY month_year) as pcnt_change
