...
SUM(CASE WHEN l.has_availability='t' THEN (30-fm.availability_30)*fm.price ELSE NULL END)::float/COUNT(DISTINCT h.host_id)::float as est_rev_per_active_listing_per_host
